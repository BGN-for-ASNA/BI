...
print("Starting BF fit (UCLN + Gamma) on Real Primate Data...")
...
if post is not None:
    ...
    df.to_csv("../Model_2_Temporal_Heterogeneity/BF_ucln_post.csv", index=False)
    print("Posteriors saved to ../Model_2_Temporal_Heterogeneity/BF_ucln_post.csv")
