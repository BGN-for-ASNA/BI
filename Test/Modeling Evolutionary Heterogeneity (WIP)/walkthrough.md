...
### 1. Model Refinement
- **UCLN + Gamma Integration**: Updated [fit_bi_ucln.py](file:///home/sosa/work/BF/Test/Modeling%20Evolutionary%20Heterogeneity%20%28WIP%29/Model_2_Temporal_Heterogeneity/fit_bi_ucln.py) to include both temporal (branch-specific rates) and spatial (site-specific rates) heterogeneity.
...
- **Joint Analysis**: Updated [compare_posteriors.py](file:///home/sosa/work/BF/Test/Modeling%20Evolutionary%20Heterogeneity%20%28WIP%29/compare_posteriors.py) to generate 2x2 density plots for all 4 parameters.
- **Automated Reporting**: Updated [generate_xtx_log.py](file:///home/sosa/work/BF/Test/Modeling%20Evolutionary%20Heterogeneity%20%28WIP%29/generate_xtx_log.py) to include all relevant parameters in the LaTeX diagnostic report.
...
| Parameter | BF Mean (SD) | BEAST Mean (SD) | Diff (%) |
| :--- | :--- | :--- | :--- |
...
![Model 2 Density Alignment](file:///home/sosa/work/BF/Test/Modeling%20Evolutionary%20Heterogeneity%20%28WIP%29/Model_2_Temporal_Heterogeneity/density_ucln.png)

> [!NOTE]
> The BF implementation used `JAX_PLATFORM_NAME=cpu` to avoid CuDNN initialization overhead during this specific validation run, ensuring clean and predictable execution.
