...
write.table(dat$Y, "../data/data_Y.csv", row.names=FALSE, col.names=FALSE, sep=",")
write.table(dat$d, "../data/data_d.csv", row.names=FALSE, col.names=FALSE, sep=",")
write.table(dat$id, "../data/data_id.csv", row.names=FALSE, col.names=FALSE, sep=",")

# Save ground truth for reference
write.table(dat$L, "../data/true_L.csv", row.names=FALSE, col.names=FALSE, sep=",")
write.table(dat$p, "../data/true_p.csv", row.names=FALSE, col.names=FALSE, sep=",")
