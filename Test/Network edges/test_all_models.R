...
plot_densities <- function(model_name, bi_draws, brms_draws,
  ...
  # Adjust plot size based on grid
  plot_width <- num_cols * 4
  plot_height <- num_rows * 4

  svg(paste0("Test/Network edges/density_plots/", model_name, "_densities.svg"),
...
run_all_combinations <- function(model_type, bi_func, num_nodes = 10, num_locations = 5, max_obs = 5) {
...
run_all_combinations(model_type = "binary", bi_func = bi_model_binary, num_nodes = 50, num_locations = 5, max_obs = 20)
run_all_combinations(model_type = "count", bi_func = bi_model_count, num_nodes = 50, num_locations = 5, max_obs = 20)
run_all_combinations(model_type = "duration", bi_func = bi_model_duration, num_nodes = 50, num_locations = 5, max_obs = 20)
