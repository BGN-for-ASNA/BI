...
This document provides a unified framework for performing Bayesian analysis of social transmission using Network-Based Diffusion Analysis (NBDA) models. Below, we detail the implementation of various models using the Bayesian Inference (**BI**) package via Python, R, and Julia. All examples assume data is loaded using standard `STbayes` structures.
...
file_path = r"c:\Users\Sosa\Documents\BI\Documentation\2. Network-Based Diffusion Analysis.qmd"
