// Generative model for SBC with 2 traits: both Gaussian/Normal
// Variant of SBC_gen2traits.stan for double Gaussian traits
functions {
...
generated quantities{
  ...
  // BOTH TRAITS ARE GAUSSIAN/NORMAL
  array[N_tree,N_obs,J] real yrep; // predictive checks
  {
    ...
    for (i in 1:N_obs) {
      for (t in 1:N_tree) {
        ...
        // Trait 2 (Gaussian/Normal) - CHANGED FROM BERNOULLI
