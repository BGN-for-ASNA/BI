...
All required changes can be tracked through the VSCode Problems list. `dists.py` is then renamed to `np_dists.py`, which is the file used by BF to import the distributions.
