...
format:
  pdf: 
    documentclass: sagej
    #classoption:
    #  - Afour  # Or use a single string: "Afour"
    #  - sageh  # Or use a single string: "sageh"
    #  - times  # Or use a single string: "times"
    ...
    include-in-header: 
      text:  |
        ...
        %\usepackage{fancybox}  % this brook qmd bi ref
        \usepackage{epstopdf}
        \usepackage{hyperref}
        \usepackage{xcolor}
        \usepackage{rotating}
...
\author{Sebastian Sosa\affilnum{1}, Mary B. McElreath\affilnum{1}, Cody T. Ross\affilnum{1}}
