  ...
  pdf: 
    ...
    include-in-header: 
      text:  |
        ...
        %\usepackage{fancybox, graphicx}  % this brook qmd bi ref
        \usepackage{epstopdf}
        \usepackage{hyperref}
        \usepackage{xcolor}
        \usepackage{rotating}
...
\DIFdelbegin 
\DIFdelend \DIFaddbegin \affiliation{\color{white}\affilnum{1}{Department of Human Behavior, Ecology, and Culture, Max Planck Institute for Evolutionary Anthropology. Leipzig, Germany.}
...
\DIFdelbegin 
\DIFdelend \DIFaddbegin \corrauth{\color{white} Sebastian Sosa, Cody T. Ross}
\DIFaddend 

\DIFdelbegin 
\DIFdelend \DIFaddbegin \email{\color{white} s.sosa@live.fr, cody\_ross@eva.mpg.de}
\DIFaddend 
