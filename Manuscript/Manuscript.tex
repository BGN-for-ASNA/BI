...
\href{https://pypi.org/project/BayesInference/}{pip} for the Python version, \href{https://cran.r-project.org/web/packages/BayesSIM/index.html}{CRAN} for the R
version, and the \href{https://juliapackages.com/p/PyBaeysianInference}{Julia package registry} for the Julia version. Comprehensive documentation, including installation instructions, tutorials, and
