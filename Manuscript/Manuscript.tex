...
\item The Bayesian Inference \textit{(}\href{https://s-sosa.com/BI}{BI}\textit{)} is a cross-platform software distributed as a \href{https://pypi.org/project/BayesInference/}{Python}, \href{https://cran.r-project.org/web/packages/BayesSIM/index.html}{R} and \href{https://juliapackages.com/p/PyBaeysianInference}{Julia} library. It provides an intuitive model-building syntax with the flexibility of low-level abstraction coding, while also providing pre-built \textit{GLM} functions. Further, by facilitating hardware-accelerated GPU computation under-the-hood, \textit{BI}  permits high-dimensional models to be fit in a fraction of the time  of comparable Stan models (up to 200-fold). 
...
\href{https://s-sosa.com/BI/1.%20Linear%20Regression%20for%20continuous%20variable.html}{Linear Regression} & Statistical Rethinking, chapter 4 \citep{rethinking} \\

\href{https://s-sosa.com/BI/2.%20Multiple%20continuous%20Variables.html}{Multiple Regression}
& Statistical Rethinking, chapter 4 \citep{rethinking} \\

\href{https://s-sosa.com/BI/3.%20Interaction%20between%20continuous%20variables.html}{Interactions}
& Statistical Rethinking, chapter 8 \citep{rethinking} \\

\href{https://s-sosa.com/BI/4.%20Categorical%20variable.html}{Categorical models}
& Statistical Rethinking, chapter 5 \citep{rethinking} \\

\href{https://s-sosa.com/BI/5.%20Binomial%20model.html}{Binomial models}
& Statistical Rethinking, chapter 11 \citep{rethinking} \\

\href{https://s-sosa.com/BI/7.%20Poisson%20model.html}{Poisson models}
& Statistical Rethinking, chapter 11 \citep{rethinking} \\

\href{https://s-sosa.com/BI/8.%20Poisson%20mode%20with%20offset.html}{Poisson models with offset}
& Statistical Rethinking, chapter 11 \citep{rethinking} \\

\href{https://s-sosa.com/BI/8.%20Gamma-Poisson.html}{Gamma-Poisson models}
& Statistical Rethinking, chapter 11 \citep{rethinking} \\

\href{https://s-sosa.com/BI/9.%20Categorical%20model.html}{Categorical models}
& Statistical Rethinking, chapter 11 \citep{rethinking} \\

\href{https://s-sosa.com/BI/10.%20Multinomial%20model.html}{Multinomial models}
& Statistical Rethinking, chapter 11 \citep{rethinking} \\

\href{https://s-sosa.com/BI/10.%20Dirichlet%20model.html}{Dirichlet models}
& Statistical Rethinking, chapter X \citep{rethinking} \\

\href{https://s-sosa.com/BI/6.%20Beta%20binomial%20model.html}{Beta-binomial models}
& Statistical Rethinking, chapter 12 \citep{rethinking} \\

\href{https://s-sosa.com/BI/11.%20Zero%20inflated.html}{Zero-inflated models}
& Statistical Rethinking, chapter 12 \citep{rethinking} \\

\href{https://s-sosa.com/BI/13.%20Varying%20intercepts.html}{Varying-intercept models}
& Statistical Rethinking, chapter 13 \citep{rethinking} \\

\href{https://s-sosa.com/BI/14.%20Varying%20slopes.html}{Varying-intercept models}
& Statistical Rethinking, chapter 13 \citep{rethinking} \\

\href{https://s-sosa.com/BI/15.%20Gaussian%20processes.html}{Gaussian process models}
& Statistical Rethinking, chapter 14 \citep{rethinking} \\

\href{https://s-sosa.com/BI/16.%20Measuring%20error.html}{Measurement-error models}
& Statistical Rethinking, chapter 15 \citep{rethinking} \\

\href{https://s-sosa.com/BI/17.%20Missing%20data%20(wip).html}{Missing-data models}
& Statistical Rethinking, chapter 15 \citep{rethinking} \\

\href{https://s-sosa.com/BI/18.%20Latent%20variable%20(wip).html}{Latent variable models}
& Bishop \& al. \citep{bishop1998latent} \\

\href{https://s-sosa.com/BI/19.%20PCA.html}{Principal Component Analysis}
& Tipping \& al. \citep{tipping1999probabilistic} \\

\href{https://s-sosa.com/BI/20.%20GMM.html}{Gaussian Mixture Models}
& Bishop \& al. \citep{bishop2006pattern} \\

\href{https://s-sosa.com/BI/21.%20DPMM.html}{Dirichlet Process Mixture Models}
& Pyro \citep{bingham2019pyro} \\

\href{https://s-sosa.com/BI/22.%20Network%20model.html}{Basic social network models}
& STRAND \citep{STRAND1} \\

\href{https://s-sosa.com/BI/23.%20Network%20with%20block%20model.html}{Stochastic blockmodels}
& STRAND \citep{STRAND1} \\

\href{https://s-sosa.com/BI/24.%20Network%20control%20for%20data%20collection%20biases.html}{Network control for data collection biases}
& STRAND \citep{STRAND2025} \\

\href{https://s-sosa.com/BI/25.%20Network%20Metrics.html}{Network metrics} &
ANTs \citep{sosa2020multilevel,sosa2021network} \\

\href{https://s-sosa.com/BI/26.%20Network%20Based%20Diffusion%20analysis%20(wip).html}{Network-based diffusion analysis}
& NBDA \citep{hoppitt2011detecting} \\

\href{https://s-sosa.com/BI/27.%20BNN.html}{Bayesian Neural Networks}
& Numpyro \citep{phan2019composable} \\

\href{https://s-sosa.com/BI/12.%20Survival%20analysis.html}{Survival Analysis}
