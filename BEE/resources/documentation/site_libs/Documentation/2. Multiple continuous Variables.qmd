...
def model(height, weight, age):
    alpha = bee.dist.normal(0, 0.5, name = 'alpha')    
    beta1 = bee.dist.normal(0, 0.5, name = 'beta1')
    beta2 = bee.dist.normal(0, 0.5, name = 'beta2')
    sigma = bee.dist.uniform(0,50, name = 'sigma')
