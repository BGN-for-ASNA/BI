...
means = BEE.distribution.normal(0, 1, shape=(NY,), sample = True, seed = 10)
offsets = BEE.distribution.normal(0, 1, shape=(NV,1), sample = True, seed = 20)
...
b_individual = BEE.distribution.normal(0, 1, shape=N, K), sample = True, seed = 0)
...
# Define model ------------------------------------------------
def model(NY, NV, Y2):
    means = bee.dist.normal(0, 1, shape=(NY,), name = 'means')
    offset = bee.dist.normal(0, 1, shape=(NY,1), name = 'offset')
    sigma = bee.dist.exponential(1, shape=(NY,), name = 'sigma')
