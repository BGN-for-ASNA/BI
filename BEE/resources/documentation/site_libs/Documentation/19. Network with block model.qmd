...
def model3(idx, result_outcomes, kinship, focal_individual_predictors, target_individual_predictors, Any, Merica, Quantum):
    ...
    # Block ---------------------------------------
    B_any, b_any, b_ij_any, b_ii_any = m.net.block_model(Any,1, name_b_ij = 'b_ij_Any', name_b_ii = 'b_ii_Any' )
    B_Merica, b_Merica, b_ij_Merica, b_ii_Merica = m.net.block_model(Merica,  3, name_b_ij = 'b_ij_Merica', name_b_ii = 'b_ii_Merica' )
    B_Quantum, b_Quantum, b_ij_Quantum, b_ii_Quantum = m.net.block_model(Quantum, 2, name_b_ij = 'b_ij_Quantum', name_b_ii = 'b_ii_Quantum' )

    ## SR ---------------------------------------
    sr_terms, focal_effects, target_effects = m.net.nodes_terms(focal_individual_predictors, target_individual_predictors)
    sr_rf, sr_raw, sr_sigma, sr_L = m.net.nodes_random_effects(sr_terms.shape[0], cholesky_density = 2)
    ...
    # Dyadic--------------------------------------  
    dr_terms, dyad_effects = m.net.dyadic_terms(kinship[:,0], kinship[:,1])
    rf, dr_raw, dr_sigma, dr_L = m.net.dyadic_random_effects(idx.shape[0], cholesky_density = 2)
    dr = dr_terms + rf
