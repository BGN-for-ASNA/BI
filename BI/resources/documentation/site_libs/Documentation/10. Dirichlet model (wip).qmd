...
# Dirichlet Model
## General Principles
To model the relationship between a categorical outcome variable with more than two categories and one or more independent variables with [<span style="color:#0D6EFD">overdispersion 🛈</span>]{#overdispersion}, we can use a _Dirichlet_ distribution.
