"""Posterior sensitivity analysis and model checking utilities for BI.
...
def influence_plot(
    ...
    Args:
        m: Fitted BI model. Used to auto-compute log_likelihood if not given.
    ...
    """
    from BI.Diagnostic.jax_diagnostics import (
...
def divergence_energy_plot(m, title="HMC Diagnostics: Energy & Divergences"):
    ...
    Args:
        m: Fitted BI model with NumPyro MCMC sampler.
        title: Plot title.
...
def multimodality_check(
    ...
    Args:
        m: Fitted BI model. Uses m.posteriors and m.posteriors_by_chain.
