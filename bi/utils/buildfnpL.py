...
## This script gather numpyro distributions functions to generate BI calsses : dists and samplers to get more 'user friendly' functions
## the last distribution function need its argument to be reorganized.
#
