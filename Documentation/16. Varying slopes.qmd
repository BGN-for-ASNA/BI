...
::: callout-note
-   We have the same considerations as for [Varying intercepts](15.%20Varying%20intercepts.qmd).
...
# Import data ------------------------------------------------
m$data(paste(system.file(package = "BayesForge"),"/data/Sim data multivariatenormal.csv", sep = ''), sep=',')
