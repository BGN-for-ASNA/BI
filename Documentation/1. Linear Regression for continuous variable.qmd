...
![Linear regression](Figures/1.png){width=60% height=60%}

## Considerations

::: callout-note
-   Bayesian models allow us to update our understanding of parameters conditional on an observed data set. This allow us to consider [<span style="color:#0D6EFD">model parameter uncertainty 🛈</span>]{#uncertainty}, which quantifies our confidence or uncertainty in the parameters in a form of a [<span style="color:#0D6EFD">posterior distribution 🛈</span>]{#posterior}. Therefore, we need to declare [<span style="color:#0D6EFD">prior distributions 🛈</span>]{#prior} for each model parameter, in this case for: $\alpha$, $\beta$, and $\sigma$.
