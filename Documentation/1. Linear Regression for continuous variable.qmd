...
- Gaussian regression deals directly with continuous outcomes, estimating a linear relationship between predictors and the outcome variable without needing a [<span style="color:#0D6EFD">link function 🛈</span>]{#linkF}. This simplifies interpretation, as coefficients represent direct changes in the outcome variable.
...
def model(weight, height):    
    ...
    m.lk("y", dist.normal(a + b * weight , s), obs=height)
