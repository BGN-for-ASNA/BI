...
In the Bayesian formulation, we define each parameter with [priors](# "Priors are distributions that represent the value of the parameter before conditioning it on the data."). We can express a Bayesian version of this regression model using the following model: 
$$
