...
To study relationships between two continuous variables (e.g.~height and
weight), we can use : \emph{Linear regression approach}. Basically, we
...
in inform us about the slope of the line and 3) an error term \(\sigma\)
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Conciderations}, breakable, toprule=.15mm, colframe=quarto-callout-caution-color-frame, coltitle=black, arc=.35mm, left=2mm, opacityback=0, colback=white]
...
\item
  ...
  thus need to declare prior distribution for \(\alpha\), \(\beta\) and
  \(\sigma^2\).
\item
  Usually, we use \emph{Normal} distribution for \(\alpha\), \(\beta\)
  and an \emph{exponential} or \emph{Gamma} distribution for \(\sigma\)
  (basically any distribution that are positively defined).
\item
...
\item
  \(\epsilon\) is vector of error terms independently distributed.
\end{itemize}
...
\hyperref[]{priors}. We can express a Bayesian version of this
regression model using the following model: \[
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Considerations}, breakable, toprule=.15mm, colframe=quarto-callout-caution-color-frame, coltitle=black, arc=.35mm, left=2mm, opacityback=0, colback=white]
...
\section{\texorpdfstring{\emph{Formula}}{Formula}}\label{formula-1}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Notes}, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, arc=.35mm, left=2mm, opacityback=0, colback=white]
...
\section{\texorpdfstring{\emph{Formula}}{Formula}}\label{formula-4}
...
\section{\texorpdfstring{\emph{Formula}}{Formula}}\label{formula-9}
...
\subsection{\texorpdfstring{\emph{Formula}}{Formula}}\label{formula-10}
...
\item
  ...
  generated for both \hyperref[]{nodal effects 🛈} and {[}dyadic effects
  🛈{]}(\# '' link-related categorical (e.g., same group membership) or
  continuous (e.g., genetic distances) characteristics between nodes'').
  Those the varying intercepts and slopes are identical to those
  described in previous chapters and will therefore not be detailed
  further and only the random centered version of the varying slopes
...
\item
  \(\lambda_i\) is the \hyperref[]{sender effect 🛈}
\item
  \(\pi_j\) is the \hyperref[]{receiver effect 🛈}
\item
  \(\delta_{ij}\) is the \hyperref[]{dyadic effect 🛈}.
\end{itemize}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note(s)}, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, arc=.35mm, left=2mm, opacityback=0, colback=white]
...
\item
  ...
  \(\lambda_i\), \(\pi_j\) , and \(\delta{ij}\) are no longer required.
  (Is it correct?)
\item
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, toptitle=1mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, breakable, toprule=.15mm, colframe=quarto-callout-caution-color-frame, coltitle=black, arc=.35mm, left=2mm, opacityback=0, colback=white]
...
\item
  ...
  estimating \hyperref[]{assortativity 🛈} and
  \hyperref[]{disassortativity 🛈} for categorical variables.
\item
