...
BI through the class \texttt{bee.dist.XXX} where \texttt{XXX} is the name
of the distribution you want to use. Within any \texttt{bee.dist.XXX}
...
functions} in BI can be accessed through the class \texttt{BEE.link.XXX}
where \texttt{XXX} is the name of the link function.

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1392}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.3093}}
...
\texttt{BEE.diag.XXX} where \texttt{XXX} is the name of the diagnostic
tool.
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-caution-color-frame, coltitle=black, colback=white, arc=.35mm, opacityback=0, toptitle=1mm, breakable, bottomtitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, leftrule=.75mm, opacitybacktitle=0.6, left=2mm]
...
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Howell1.csv\textquotesingle{}}
...
\NormalTok{  s }\OtherTok{=} \FunctionTok{bee.dist.uniform}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{50}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{)}
\NormalTok{  a }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{178}\NormalTok{, }\DecValTok{20}\NormalTok{,  }\AttributeTok{name =} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{  b }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, colback=white, arc=.35mm, opacityback=0, toptitle=1mm, breakable, bottomtitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, opacitybacktitle=0.6, left=2mm]
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(height, weight, age)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{( }\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{  beta1 }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{( }\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b1\textquotesingle{}}\NormalTok{)}
\NormalTok{  beta2 }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(  }\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b2\textquotesingle{}}\NormalTok{)   }
\NormalTok{  sigma }\OtherTok{=} \FunctionTok{bee.dist.uniform}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{50}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{)}
  \CommentTok{\# Likelihood}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}tulips.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{)}
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(blooms, water,shade)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{( }\FloatTok{0.5}\NormalTok{, }\FloatTok{0.25}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{  beta1 }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{( }\DecValTok{0}\NormalTok{,  }\FloatTok{0.25}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b1\textquotesingle{}}\NormalTok{)}
\NormalTok{  beta2 }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(  }\DecValTok{0}\NormalTok{,  }\FloatTok{0.25}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b2\textquotesingle{}}\NormalTok{)}
\NormalTok{  beta\_interaction\_ }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(  }\DecValTok{0}\NormalTok{, }\FloatTok{0.25}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}bint\textquotesingle{}}\NormalTok{)}
\NormalTok{  sigma }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{50}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{)}
  \CommentTok{\# Likelihood}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}milk.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ m.bee.dist.normal(}\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{4}\NormalTok{,), name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{) }\CommentTok{\# shape based on the number of clades}
\NormalTok{    s }\OperatorTok{=}\NormalTok{ m.bee.dist.exponential( }\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{)    }
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(kcal\_per\_g, index\_clade)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  beta }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{( }\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}beta\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{))  }\CommentTok{\# shape based on the number of clades}
\NormalTok{  sigma }\OtherTok{=}\FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{)}
  \CommentTok{\# Likelihood}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}chimpanzees.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{)}
...
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{( }\DecValTok{0}\NormalTok{, }\DecValTok{10}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{)}
  \CommentTok{\# Likelihood}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}UCBadmit.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(gid, applications, admit)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  phi }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}phi\textquotesingle{}}\NormalTok{,}\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\FloatTok{0.}\NormalTok{, }\FloatTok{1.5}\NormalTok{, }\AttributeTok{shape=} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{), }\AttributeTok{name=}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{)}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Kline.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{)}
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(total\_tools, population, cid)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{3}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{))}
\NormalTok{  beta }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.2}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}beta\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{))}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Sim dat Gamma poisson.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{},\textquotesingle{}}\NormalTok{) }
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(log\_days, monastery, y)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{, }\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
\NormalTok{  beta }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}beta\textquotesingle{}}\NormalTok{, }\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Sim data multinomial.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{},\textquotesingle{}}\NormalTok{) }
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(income, career)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{))}
\NormalTok{  beta }\OtherTok{=} \FunctionTok{bee.dist.halfnormal}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}beta\textquotesingle{}}\NormalTok{)}
...
\NormalTok{drink }\OtherTok{=} \FunctionTok{bee.dist.binomial}\NormalTok{(}\AttributeTok{total\_count =} \FunctionTok{as.integer}\NormalTok{(}\DecValTok{1}\NormalTok{), }\AttributeTok{probs =}\NormalTok{ prob\_drink, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(N), }\AttributeTok{sample =}\NormalTok{ T ) }\CommentTok{\# An example of sampling a distribution with BI}
\NormalTok{y }\OtherTok{=}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ drink) }\SpecialCharTok{*}  \FunctionTok{bee.dist.poisson}\NormalTok{(rate\_work, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(N), }\AttributeTok{sample =}\NormalTok{ T)}
...
\NormalTok{  al }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{1}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}al\textquotesingle{}}\NormalTok{, }\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
\NormalTok{  ap }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}ap\textquotesingle{}}\NormalTok{, }\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}mastectomy.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{},\textquotesingle{}}\NormalTok{) }
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}reedfrogs.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }
\CommentTok{\# Manipulate}
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(tank, surv, density)\{}
  \CommentTok{\# Parameter prior distributions}
\NormalTok{  sigma }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{( }\DecValTok{1}\NormalTok{,  }\AttributeTok{name =} \StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{,}\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
\NormalTok{  a\_bar }\OtherTok{=}  \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{1.5}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}a\_bar\textquotesingle{}}\NormalTok{,}\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
\NormalTok{  alpha }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(a\_bar, sigma, }\AttributeTok{name=}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =}\FunctionTok{c}\NormalTok{(}\DecValTok{48}\NormalTok{))}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Sim data multivariatenormal.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{},\textquotesingle{}}\NormalTok{) }
...
\NormalTok{  a }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DecValTok{2}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{  b }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
\NormalTok{  sigma\_cafe }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{shape=} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{), }\AttributeTok{name =} \StringTok{\textquotesingle{}sigma\_cafe\textquotesingle{}}\NormalTok{)}
\NormalTok{  sigma }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{( }\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{)}
\NormalTok{  Rho }\OtherTok{=} \FunctionTok{bee.dist.lkj}\NormalTok{(}\FunctionTok{as.integer}\NormalTok{(}\DecValTok{2}\NormalTok{), }\FunctionTok{as.integer}\NormalTok{(}\DecValTok{2}\NormalTok{), }\AttributeTok{name =} \StringTok{\textquotesingle{}Rho\textquotesingle{}}\NormalTok{)}
...
\NormalTok{  a\_cafe\_b\_cafe }\OtherTok{=} \FunctionTok{bee.dist.multivariatenormal}\NormalTok{(}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Kline2.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }

\NormalTok{data\_path2 }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}Kline2.csv\textquotesingle{}}
...
\NormalTok{  a }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{  b }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
\NormalTok{  g }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}g\textquotesingle{}}\NormalTok{)}
  
  \CommentTok{\# non{-}centered Gaussian Process prior}
\NormalTok{  etasq }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\DecValTok{2}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}etasq\textquotesingle{}}\NormalTok{)}
\NormalTok{  rhosq }\OtherTok{=} \FunctionTok{bee.dist.exponential}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}rhosq\textquotesingle{}}\NormalTok{)}
\NormalTok{  z }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}z\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(}\DecValTok{10}\NormalTok{))}
...
\CommentTok{\# Import}
\ImportTok{from}\NormalTok{ importlib.resources }\ImportTok{import}\NormalTok{ files}
\NormalTok{data\_path }\OperatorTok{=}\NormalTok{ files(}\StringTok{\textquotesingle{}BEE.resources.data\textquotesingle{}}\NormalTok{) }\OperatorTok{/} \StringTok{\textquotesingle{}WaffleDivorce.csv\textquotesingle{}}
\NormalTok{m.data(data\_path, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }
...
\NormalTok{b\_individual }\OperatorTok{=}\NormalTok{ BEE.distribution.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(N, K), sample}\OperatorTok{=}\VariableTok{True}\NormalTok{, seed}\OperatorTok{=}\DecValTok{0}\NormalTok{)}
...
\NormalTok{    w }\OperatorTok{=}\NormalTok{ bee.dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(data\_dim, latent\_dim), name}\OperatorTok{=}\StringTok{\textquotesingle{}w\textquotesingle{}}\NormalTok{, sample}\OperatorTok{=}\VariableTok{True}\NormalTok{, seed}\OperatorTok{=}\NormalTok{seed)}
\NormalTok{    z }\OperatorTok{=}\NormalTok{ bee.dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(latent\_dim, num\_datapoints), name}\OperatorTok{=}\StringTok{\textquotesingle{}z\textquotesingle{}}\NormalTok{, sample}\OperatorTok{=}\VariableTok{True}\NormalTok{, seed}\OperatorTok{=}\NormalTok{seed)}
\NormalTok{    x }\OperatorTok{=}\NormalTok{ bee.dist.normal(w }\OperatorTok{@}\NormalTok{ z, stddv\_datapoints, name}\OperatorTok{=}\StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{, sample}\OperatorTok{=}\VariableTok{True}\NormalTok{, seed}\OperatorTok{=}\NormalTok{seed)}
...
\NormalTok{    w }\OperatorTok{=}\NormalTok{ bee.dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(data\_dim, latent\_dim), name}\OperatorTok{=}\StringTok{\textquotesingle{}w\textquotesingle{}}\NormalTok{)}
\NormalTok{    z }\OperatorTok{=}\NormalTok{ bee.dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(latent\_dim, num\_datapoints), name}\OperatorTok{=}\StringTok{\textquotesingle{}z\textquotesingle{}}\NormalTok{)}
...
\section{Python}\label{python-16}
...
\NormalTok{    result\_outcomes }\OperatorTok{=}\NormalTok{ BEE.net.mat\_to\_edgl(data[}\StringTok{\textquotesingle{}outcomes\textquotesingle{}}\NormalTok{]), }
\NormalTok{    dyad\_effects }\OperatorTok{=}\NormalTok{ BEE.net.prepare\_dyadic\_effect(kinship), }\CommentTok{\# Can be a jax array of multiple dimensions}
...
\NormalTok{idx }\OperatorTok{=}\NormalTok{ BEE.net.vec\_node\_to\_edgle(jnp.stack([ids, ids], axis }\OperatorTok{=} \OperatorTok{{-}}\DecValTok{1}\NormalTok{))}
...
\NormalTok{    sr\_rf, sr\_raw, sr\_sigma, sr\_L }\OperatorTok{=}\NormalTok{ BEE.net.nodes\_random\_effects(N\_id, cholesky\_density }\OperatorTok{=} \DecValTok{2}\NormalTok{) }
...
\NormalTok{    rf, dr\_raw, dr\_sigma, dr\_L }\OperatorTok{=}\NormalTok{ BEE.net.dyadic\_random\_effects(sender\_receiver.shape[}\DecValTok{0}\NormalTok{], cholesky\_density }\OperatorTok{=} \DecValTok{2}\NormalTok{)}
\NormalTok{    dr }\OperatorTok{=}\NormalTok{  rf}

\NormalTok{    m.poisson(jnp.exp( sender\_receiver }\OperatorTok{+}\NormalTok{ dr ), obs}\OperatorTok{=}\NormalTok{result\_outcomes)}
...
\NormalTok{  B }\OtherTok{=} \FunctionTok{bee.dist.normal}\NormalTok{(tmp, }\FloatTok{2.5}\NormalTok{, }\AttributeTok{shape=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{), }\AttributeTok{name =} \StringTok{\textquotesingle{}block\textquotesingle{}}\NormalTok{)}
...
\NormalTok{  sr }\OtherTok{=}\NormalTok{  m}\SpecialCharTok{$}\NormalTok{net}\SpecialCharTok{$}\FunctionTok{sender\_receiver}\NormalTok{(focal\_individual\_predictors,target\_individual\_predictors)}
  ...
  \CommentTok{\#dr, dr\_raw, dr\_sigma, dr\_L = BEE.net.dyadic\_random\_effects(idx.shape[0], cholesky\_density = 2)\# shape = n dyads}
...
\NormalTok{    sr\_terms, focal\_effects, target\_effects }\OperatorTok{=}\NormalTok{ BEE.net.nodes\_terms(focal\_individual\_predictors, target\_individual\_predictors) }
...
\NormalTok{    dr\_terms, dyad\_effects }\OperatorTok{=}\NormalTok{ BEE.net.dyadic\_terms(dyad\_effects)}
...
\NormalTok{    N\_id }\OperatorTok{=}\NormalTok{ ids.shape[}\DecValTok{0}\NormalTok{]}
    ...
    \CommentTok{\# Block {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{    B\_any, b\_any, b\_ij\_any, b\_ii\_any }\OperatorTok{=}\NormalTok{ BEE.net.block\_model(Any, }\DecValTok{1}\NormalTok{, name\_b\_ij}\OperatorTok{=}\StringTok{\textquotesingle{}b\_ij\_Any\textquotesingle{}}\NormalTok{, name\_b\_ii}\OperatorTok{=}\StringTok{\textquotesingle{}b\_ii\_Any\textquotesingle{}}\NormalTok{)}
\NormalTok{    B\_Merica, b\_Merica, b\_ij\_Merica, b\_ii\_Merica }\OperatorTok{=}\NormalTok{ BEE.net.block\_model(Merica, }\DecValTok{3}\NormalTok{, name\_b\_ij}\OperatorTok{=}\StringTok{\textquotesingle{}b\_ij\_Merica\textquotesingle{}}\NormalTok{, name\_b\_ii}\OperatorTok{=}\StringTok{\textquotesingle{}b\_ii\_Merica\textquotesingle{}}\NormalTok{)}
\NormalTok{    B\_Quantum, b\_Quantum, b\_ij\_Quantum, b\_ii\_Quantum }\OperatorTok{=}\NormalTok{ BEE.net.block\_model(Quantum, }\DecValTok{2}\NormalTok{, name\_b\_ij}\OperatorTok{=}\StringTok{\textquotesingle{}b\_ij\_Quantum\textquotesingle{}}\NormalTok{, name\_b\_ii}\OperatorTok{=}\StringTok{\textquotesingle{}b\_ii\_Quantum\textquotesingle{}}\NormalTok{)}

    \CommentTok{\#\# SR {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{    sr\_terms, focal\_effects, target\_effects }\OperatorTok{=}\NormalTok{ BEE.net.nodes\_terms(focal\_individual\_predictors, target\_individual\_predictors)}
\NormalTok{    sr\_rf, sr\_raw, sr\_sigma, sr\_L }\OperatorTok{=}\NormalTok{ BEE.net.nodes\_random\_effects(sr\_terms.shape[}\DecValTok{0}\NormalTok{], cholesky\_density}\OperatorTok{=}\DecValTok{2}\NormalTok{)}
...
\NormalTok{    sender\_receiver }\OperatorTok{=}\NormalTok{ jnp.stack([sender, receiver], axis}\OperatorTok{=}\DecValTok{1}\NormalTok{)}
    ...
    \CommentTok{\# Dyadic{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}  }
\NormalTok{    dr\_terms, dyad\_effects }\OperatorTok{=}\NormalTok{ BEE.net.dyadic\_terms(kinship[:,}\DecValTok{0}\NormalTok{], kinship[:,}\DecValTok{1}\NormalTok{])}
\NormalTok{    rf, dr\_raw, dr\_sigma, dr\_L }\OperatorTok{=}\NormalTok{ BEE.net.dyadic\_random\_effects(idx.shape[}\DecValTok{0}\NormalTok{], cholesky\_density}\OperatorTok{=}\DecValTok{2}\NormalTok{)}
\NormalTok{    dr }\OperatorTok{=}\NormalTok{ dr\_terms }\OperatorTok{+}\NormalTok{ rf}
...
\NormalTok{    result\_outcomes}\OperatorTok{=}\NormalTok{BEE.net.mat\_to\_edgl(data[}\StringTok{\textquotesingle{}outcomes\textquotesingle{}}\NormalTok{]), }
\NormalTok{    kinship}\OperatorTok{=}\NormalTok{BEE.net.mat\_to\_edgl(kinship),}
\NormalTok{    focal\_individual\_predictors}\OperatorTok{=}\NormalTok{data[}\StringTok{\textquotesingle{}individual\_predictors\textquotesingle{}}\NormalTok{],}
\NormalTok{    target\_individual\_predictors}\OperatorTok{=}\NormalTok{data[}\StringTok{\textquotesingle{}individual\_predictors\textquotesingle{}}\NormalTok{]}
\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{from}\NormalTok{ .BEE.main }\ImportTok{import} \OperatorTok{*}
\CommentTok{\# Setup device{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m }\OperatorTok{=}\NormalTok{ bi(platform}\OperatorTok{=}\StringTok{\textquotesingle{}cpu\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    m.binomial(exposure, jnp.exp(B\_any }\OperatorTok{+}\NormalTok{ B\_Merica }\OperatorTok{+}\NormalTok{ B\_Quantum }\OperatorTok{+}\NormalTok{ sender\_receiver }\OperatorTok{+}\NormalTok{ dr), obs}\OperatorTok{=}\NormalTok{result\_outcomes)}
...
0 & \text{when no interaction occurs or when i or j is not detectable} \\
...
Where: - \(\mu_\psi\) is the intercept. - \(\sigma_\psi\) is a scalar
for the variance of random effects. -
...
\texttt{BEE.net.}, implemented with JAX and usable within any bi model.
...
The degree \texttt{BEE.net.degree} measures the number of links of a
node. When computed on an undirected network, the degree represents the
number of alters of an ego. When the network is directed\emph{, it
represents the number of either incoming} or outgoing* links of an ego,
and it is then called in-degree \texttt{BEE.net.indegree} or out-degree
\texttt{BEE.net.outdegree}, respectively. Note that degree can also be
...
Strength (or weighted degree) \texttt{BEE.net.strength} is the sum of the
...
in-strength \texttt{BEE.net.instrength} (the sum of weights of incoming
links) and out-strength \texttt{BEE.net.outstrength} (the sum of weights
...
Eigenvector centrality \texttt{BEE.net.eigenvector} is the first
...
The local clustering coefficient \texttt{BEE.net.cc} measures the number
...
The density \texttt{BEE.net.density} is the ratio of existing links to
all potential links in a network. This measure is easy to interpret; it
...
Geodesic distance \texttt{BEE.net.geodesic\_distance} is the shortest
...
The diameter \texttt{BEE.net.diameter} of a network represents the
longest of the shortest paths in the network. The diameter is used in
ASNA to examine aspects such as network cohesion and the rapidness of
