...
\NormalTok{drink }\OperatorTok{=}\NormalTok{ m.BEE.binomial(}\DecValTok{1}\NormalTok{, prob\_drink, shape }\OperatorTok{=}\NormalTok{ (N,), sample }\OperatorTok{=} \VariableTok{True}\NormalTok{)}
\NormalTok{y }\OperatorTok{=}\NormalTok{ (}\DecValTok{1} \OperatorTok{{-}}\NormalTok{ drink) }\OperatorTok{*}\NormalTok{ m.BEE.poisson(rate\_work, shape }\OperatorTok{=}\NormalTok{ (N,), sample }\OperatorTok{=} \VariableTok{True}\NormalTok{)}
