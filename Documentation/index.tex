...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, bottomtitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, arc=.35mm, colback=white, rightrule=.15mm, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, breakable, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, bottomtitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, colback=white, rightrule=.15mm, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, breakable, opacityback=0]
...
Where: - \(X\) is the observed data matrix. -
\(Z \in \mathbb{R}^{N \times K}\) is the latent variable matrix (latent
features with \(K \ll D\). - \(W \in \mathbb{R}^{D \times K}\) is the
matrix of principal components (projection matrix). - \(\epsilon\) is
Gaussian noise, assumed to be normally distributed:
...
\subsection{\texorpdfstring{\emph{Formulation}}{Formulation}}\label{formulation}
...
\[
\lambda_i(t) = \lambda_0(t) (1- z_i(t))  \left[ s \sum_{j = 1}^{N} a_{ij} z_j (t) + 1 \right] 
\]
...
\item
  ...
  transmission (that is, through asocial learning).
\item
  \(z_i(t)\) gives the status (1 = informed, 0 = naïve) of individual
  \emph{i} at time \emph{t}.
\item
  \((1- z_i(t))\) and \(z_j (t)\) terms ensure that the task solution is
  only transmitted from informed to uninformed individuals: \[
...
like for survival analysis we can specify the priors as followed:
...
\section{Considerations}\label{considerations-26}

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, bottomtitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, arc=.35mm, colback=white, rightrule=.15mm, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, breakable, opacityback=0]

\end{tcolorbox}

\section{Example}\label{example-25}
...
\section{Mathematical Details}\label{mathematical-details-27}
