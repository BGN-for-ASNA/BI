...
error arround the prediction.

\includegraphics{index_files/mediabag/1-WCcaObzvvVzcrg8CBi.webp}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Conciderations}, colback=white, colframe=quarto-callout-caution-color-frame]
...
\item
  ...
  and an \emph{exponential} or \emph{Gamma} distributiuon for \(\sigma\)
  (basically any distribution that are positivelly defined).
\item
  As we concider that data is standardized (see introduction) we use a
  distribution of mean 0 and of standard deviation of 1.
\item
  \(\sigma\) is assumed to be strictily positive.
\item
...
In the Bayesian formulation we define each parameters with
...
Where: - \(Y_i\) is the target variable. - \(\beta\) and \(\alpha\) are
the regression coefficients and intercept paramters, respectively. -
\(\sigma\), is prior .
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Considerations}, colback=white, colframe=quarto-callout-caution-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Notes}, colback=white, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note(s)}, colback=white, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colback=white, colframe=quarto-callout-caution-color-frame]
