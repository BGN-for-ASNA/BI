...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colframe=quarto-callout-caution-color-frame, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, rightrule=.15mm, coltitle=black, bottomrule=.15mm, toptitle=1mm, arc=.35mm, toprule=.15mm, left=2mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.normal(a }\OperatorTok{+}\NormalTok{ b }\OperatorTok{*}\NormalTok{ weight , s), obs}\OperatorTok{=}\NormalTok{height)}
...
\NormalTok{  m}\SpecialCharTok{$}\NormalTok{lk}\SpecialCharTok{$}\FunctionTok{normal}\NormalTok{(a }\SpecialCharTok{+}\NormalTok{ b }\SpecialCharTok{*}\NormalTok{ weight, s, }\AttributeTok{obs =}\NormalTok{ height)}
\NormalTok{\}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, coltitle=black, bottomrule=.15mm, toptitle=1mm, arc=.35mm, toprule=.15mm, left=2mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\NormalTok{    sigma }\OperatorTok{=}\NormalTok{ bi.dist.uniform(}\DecValTok{0}\NormalTok{,}\DecValTok{50}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{)}
    \CommentTok{\# Likelihood}
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.normal(alpha }\OperatorTok{+}\NormalTok{ beta1 }\OperatorTok{*}\NormalTok{ weight }\OperatorTok{+}\NormalTok{ beta2 }\OperatorTok{*}\NormalTok{ age, sigma), obs }\OperatorTok{=}\NormalTok{ height)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.normal(mu, sigma), obs}\OperatorTok{=}\NormalTok{blooms)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, bi.dist.normal(mu, s), obs}\OperatorTok{=}\NormalTok{kcal\_per\_g)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, m.dist.binomial(logits}\OperatorTok{=}\NormalTok{a[}\DecValTok{0}\NormalTok{]), obs}\OperatorTok{=}\NormalTok{pulled\_left)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.betabinomial(total\_count }\OperatorTok{=}\NormalTok{ applications, concentration1 }\OperatorTok{=}\NormalTok{ concentration1, concentration0 }\OperatorTok{=}\NormalTok{ concentration0), obs}\OperatorTok{=}\NormalTok{admit)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.poisson(l), obs}\OperatorTok{=}\NormalTok{total\_tools)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.poisson(rate }\OperatorTok{=}\NormalTok{ l), obs}\OperatorTok{=}\NormalTok{y)}
\CommentTok{\# Run MCMC {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m.run(model) }\CommentTok{\# Optimize model parameters through MCMC sampling}
...
\NormalTok{    b }\OperatorTok{=}\NormalTok{ bi.dist.halfnormal(}\FloatTok{0.5}\NormalTok{,  shape}\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,),name }\OperatorTok{=} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.categorical(probs }\OperatorTok{=}\NormalTok{  p), obs}\OperatorTok{=}\NormalTok{career)}
...
\NormalTok{  beta }\OtherTok{=} \FunctionTok{bi.dist.halfnormal}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\AttributeTok{name=}\StringTok{\textquotesingle{}beta\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{))}
...
\NormalTok{  p }\OtherTok{=}\NormalTok{ jax}\SpecialCharTok{$}\NormalTok{nn}\SpecialCharTok{$}\FunctionTok{softmax}\NormalTok{(jnp}\SpecialCharTok{$}\FunctionTok{stack}\NormalTok{(}\FunctionTok{list}\NormalTok{(s\_1[}\DecValTok{0}\NormalTok{], s\_2[}\DecValTok{0}\NormalTok{], s\_3[}\DecValTok{0}\NormalTok{])))}
  \CommentTok{\# Likelihood}
\NormalTok{  m}\SpecialCharTok{$}\FunctionTok{lk}\NormalTok{(}\StringTok{"y"}\NormalTok{, }\FunctionTok{bi.categorical}\NormalTok{(}\AttributeTok{probs=}\NormalTok{p[career]), }\AttributeTok{obs=}\NormalTok{career)}
\NormalTok{\}}


\CommentTok{\# Run MCMC {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(model,}\AttributeTok{seed=}\FunctionTok{as.integer}\NormalTok{(}\DecValTok{0}\NormalTok{)) }\CommentTok{\# Optimize model parameters through MCMC sampling}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.zeroinflatedpoisson(p, lambda\_), obs}\OperatorTok{=}\NormalTok{y)}
...
\NormalTok{  m}\SpecialCharTok{$}\FunctionTok{lk}\NormalTok{(}\StringTok{"y"}\NormalTok{,}\FunctionTok{bi.dist.zeroinflatedpoisson}\NormalTok{(p, lambda\_), }\AttributeTok{obs=}\NormalTok{y)}
\NormalTok{\}}
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, m.binomial(total\_count }\OperatorTok{=}\NormalTok{ density, logits }\OperatorTok{=}\NormalTok{ p), obs}\OperatorTok{=}\NormalTok{surv)}
...
\NormalTok{  alpha }\OtherTok{=}\NormalTok{m}\SpecialCharTok{$}\NormalTok{dist}\SpecialCharTok{$}\FunctionTok{normal}\NormalTok{(a\_bar, sigma, }\AttributeTok{name=}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{, }\AttributeTok{shape =}\FunctionTok{tuple}\NormalTok{(}\FunctionTok{as.integer}\NormalTok{(}\DecValTok{48}\NormalTok{)))}
\NormalTok{  p }\OtherTok{=}\NormalTok{ alpha[tank]}
  \CommentTok{\# Likelihood}
\NormalTok{  m}\SpecialCharTok{$}\FunctionTok{lk}\NormalTok{(}\StringTok{"y"}\NormalTok{, }\FunctionTok{bi.dist.binomial}\NormalTok{(}\AttributeTok{total\_count =}\NormalTok{ density, }\AttributeTok{logits =}\NormalTok{ p), }\AttributeTok{obs=}\NormalTok{surv)}
\NormalTok{\} }
...
\NormalTok{    m.lk(}\StringTok{"y"}\NormalTok{, dist.normal(mu, sigma), obs}\OperatorTok{=}\NormalTok{wait)}
