...
\NormalTok{drink }\OperatorTok{=}\NormalTok{ m.bi.binomial(}\DecValTok{1}\NormalTok{, prob\_drink, shape }\OperatorTok{=}\NormalTok{ (N,), sample }\OperatorTok{=} \VariableTok{True}\NormalTok{)}
\NormalTok{y }\OperatorTok{=}\NormalTok{ (}\DecValTok{1} \OperatorTok{{-}}\NormalTok{ drink) }\OperatorTok{*}\NormalTok{ m.bi.poisson(rate\_work, shape }\OperatorTok{=}\NormalTok{ (N,), sample }\OperatorTok{=} \VariableTok{True}\NormalTok{)}
...
\NormalTok{  sr }\OtherTok{=}\NormalTok{  m}\SpecialCharTok{$}\NormalTok{net}\SpecialCharTok{$}\FunctionTok{sender\_receiver}\NormalTok{(focal\_individual\_predictors,target\_individual\_predictors)}
  ...
  \CommentTok{\#dr, dr\_raw, dr\_sigma, dr\_L = bi.net.dyadic\_random\_effects(idx.shape[0], cholesky\_density = 2)\# shape = n dyads}
...
and it is then called in-degree \texttt{bi.net.indegree} or out-degree
...
Strength (or weighted degree) \texttt{bi.net.strength} is the sum of the
...
links) and out-strength \texttt{bi.net.outstrength} (the sum of weights
...
The density \texttt{bi.net.density} is the ratio of existing links to
