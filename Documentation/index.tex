...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, arc=.35mm, colback=white, rightrule=.15mm, coltitle=black, toprule=.15mm, opacityback=0, breakable, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colframe=quarto-callout-caution-color-frame, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, rightrule=.15mm, coltitle=black, toprule=.15mm, opacityback=0, breakable, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, left=2mm]
...
\NormalTok{Kline2 }\OperatorTok{=}\NormalTok{ pd.read\_csv(}\StringTok{\textquotesingle{}resources/data/Kline2.csv\textquotesingle{}}\NormalTok{, sep}\OperatorTok{=}\StringTok{";"}\NormalTok{)}
...
\NormalTok{d }\OperatorTok{=}\NormalTok{ Kline2}
\NormalTok{d[}\StringTok{"society"}\NormalTok{] }\OperatorTok{=} \BuiltInTok{range}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{11}\NormalTok{)  }\CommentTok{\# index observations}


\NormalTok{dat\_list }\OperatorTok{=} \BuiltInTok{dict}\NormalTok{(}
\NormalTok{    T}\OperatorTok{=}\NormalTok{d.total\_tools.values,}
\NormalTok{    P}\OperatorTok{=}\NormalTok{d.population.values,}
\NormalTok{    society}\OperatorTok{=}\NormalTok{d.society.values }\OperatorTok{{-}} \DecValTok{1}\NormalTok{,}
\NormalTok{    Dmat}\OperatorTok{=}\NormalTok{islandsDistMatrix.values,}
\NormalTok{)}
...
\KeywordTok{def}\NormalTok{ model(Dmat, P, society, T):}
\NormalTok{    a }\OperatorTok{=}\NormalTok{ bi.dsit.exponential(}\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{    b }\OperatorTok{=}\NormalTok{ bi.dsit.exponential(}\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
\NormalTok{    g }\OperatorTok{=}\NormalTok{ bi.dsit.exponential(}\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}g\textquotesingle{}}\NormalTok{)}
\NormalTok{    etasq }\OperatorTok{=}\NormalTok{ bi.dsit.exponential(}\DecValTok{2}\NormalTok{, }\StringTok{\textquotesingle{}etasq\textquotesingle{}}\NormalTok{)}
\NormalTok{    rhosq }\OperatorTok{=}\NormalTok{ bi.dsit.exponential(}\FloatTok{0.5} \StringTok{\textquotesingle{}rhosq\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    L\_SIGMA }\OperatorTok{=}\NormalTok{ jnp.linalg.cholesky(SIGMA)}
\NormalTok{    z }\OperatorTok{=}\NormalTok{ normal(}\StringTok{\textquotesingle{}z\textquotesingle{}}\NormalTok{, [}\DecValTok{10}\NormalTok{], }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{    k }\OperatorTok{=}\NormalTok{ (L\_SIGMA }\OperatorTok{@}\NormalTok{ z[..., }\VariableTok{None}\NormalTok{])[..., }\DecValTok{0}\NormalTok{]}
\NormalTok{    lambda\_ }\OperatorTok{=}\NormalTok{ a }\OperatorTok{*}\NormalTok{ P}\OperatorTok{**}\NormalTok{b }\OperatorTok{/}\NormalTok{ g }\OperatorTok{*}\NormalTok{ jnp.exp(k[society])}
\NormalTok{    sample(}\StringTok{"T"}\NormalTok{, Poisson(lambda\_), obs}\OperatorTok{=}\NormalTok{T)}

\CommentTok{\# Run sampler {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
  
\NormalTok{m14\_8.run(model) }

\NormalTok{m14\_8.sampler.print\_summary(}\FloatTok{0.89}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{R implementation would go here}\CommentTok{\#}
\end{Highlighting}
\end{Shaded}
...
\section{\texorpdfstring{\emph{Bayesian
