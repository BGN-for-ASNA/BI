...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-caution-color!10!white, leftrule=.75mm, colback=white, breakable, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, opacityback=0, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-caution-color-frame, toptitle=1mm, titlerule=0mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, colback=white, breakable, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, opacitybacktitle=0.6]
