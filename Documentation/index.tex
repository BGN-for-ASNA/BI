...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, rightrule=.15mm, bottomtitle=1mm, colback=white, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, toprule=.15mm, breakable, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, rightrule=.15mm, bottomtitle=1mm, colback=white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, toprule=.15mm, breakable, toptitle=1mm]
