...
and weight), we can use a linear regression approach. Essentially, we
draw a line that passes through the point cloud of the two variables
being tested. For this, we need to have:
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, leftrule=.75mm, opacitybacktitle=0.6, bottomrule=.15mm, arc=.35mm, left=2mm, colback=white, coltitle=black, opacityback=0, colframe=quarto-callout-caution-color-frame, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, rightrule=.15mm, breakable]
...
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{scale}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\StringTok{\textquotesingle{}weight\textquotesingle{}}\NormalTok{)) }\CommentTok{\# Scale}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{data\_to\_model}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\StringTok{\textquotesingle{}weight\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}height\textquotesingle{}}\NormalTok{)) }\CommentTok{\# Send to model (convert to jax array)}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, opacitybacktitle=0.6, bottomrule=.15mm, arc=.35mm, left=2mm, colback=white, coltitle=black, opacityback=0, colframe=quarto-callout-note-color-frame, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, breakable]

We can observe a difference between the \emph{Frequentist} and the
\emph{Bayesian} formulation regarding the error term. Indeed,
...
regression using the Bayesian Inference (BI) package. Data consist of
three continuous variables (\emph{height}, \emph{weight}, \emph{age}),
and the goal is to estimate the effect of \emph{weight} and \emph{age}
on \emph{height}.
...
\item
  ...
  for continuous variable}.
\item
  Model the relationship between independent variable \emph{Y} and
  dependent variable \(X_1\) to vary as a function of dependent variable
  \(X_2\). You explicitly model the hypothesis that the slope between
  \emph{Y} and \(X_1\) depends---is conditional---upon \(X_2\).
\item
...
\item
  ...
  understanding the impact of interactions, specially when more than two
...
the effect of interaction between temperature and humidity on energy
consumption.
...
\CommentTok{\# Import Data \& Data Manipulation {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{(}\StringTok{\textquotesingle{}../data/tulips.csv\textquotesingle{}}\NormalTok{, }\AttributeTok{sep=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }\CommentTok{\# Import}
...
\CommentTok{\# Import Data \& Data Manipulation {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{(}\StringTok{\textquotesingle{}../data/chimpanzees.csv\textquotesingle{}}\NormalTok{, }\AttributeTok{sep=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }\CommentTok{\# Import}
...
\CommentTok{\# Import Data \& Data Manipulation {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{(}\StringTok{\textquotesingle{}../data/UCBadmit.csv\textquotesingle{}}\NormalTok{, }\AttributeTok{sep=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }\CommentTok{\# Import}
...
\NormalTok{  eta }\OtherTok{=}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ pbar) }\SpecialCharTok{*}\NormalTok{ t}
  \CommentTok{\# Likelihood}
\NormalTok{  bi}\SpecialCharTok{$}\FunctionTok{lk}\NormalTok{(}\StringTok{"y"}\NormalTok{, bi}\SpecialCharTok{$}\FunctionTok{BetaBinomial}\NormalTok{(}\AttributeTok{total\_count=}\NormalTok{applications, }\AttributeTok{concentration1=}\NormalTok{gamma, }\AttributeTok{concentration0=}\NormalTok{eta), }\AttributeTok{obs=}\NormalTok{admit)}
\NormalTok{\}}
...
\CommentTok{\# Import Data \& Data Manipulation {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{(}\StringTok{\textquotesingle{}../data/Kline.csv\textquotesingle{}}\NormalTok{, }\AttributeTok{sep=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }\CommentTok{\# Import}
...
\CommentTok{\# Import data {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{(}\StringTok{\textquotesingle{}Sim dat Gamma poisson.csv\textquotesingle{}}\NormalTok{, }\AttributeTok{sep=}\StringTok{\textquotesingle{},\textquotesingle{}}\NormalTok{) }\CommentTok{\# Import}
...
death, recovery) occurs. When analyzing binary survival outcomes (e.g.,
alive or dead), we can use models such as Cox proportional hazards to
evaluate the effect of predictors on survival probabilities.
...
\item
  ...
  \item
    ...
    accounted for in the likelihood function.
  \end{itemize}
\item
  Bayesian survival models allow flexible handling of time-dependent
  covariates and incorporate uncertainty more naturally than Frequentist
  methods.
\end{itemize}
...
\tightlist
\item
  Bayesian models naturally incorporate uncertainty in all parameters,
  providing posterior distributions instead of point estimates.
\item
  Survival analysis must consider censored data, where events are not
  observed within the study period. Proper handling is essential for
  unbiased results.
\end{itemize}
...
\item
  Each intercept have is own prior -i.e.~a
...
\subsection{Bayesian PCA Model:}\label{bayesian-pca-model}

Given an observed data matrix ( X \in \mathbb{R}\^{}\{N \times D\} )
(where \emph{N} is the number of samples and \emph{D} is the number of
...
Where: - ( X ) is the observed data matrix. - ( Z \in \mathbb{R}\^{}\{N
\times K\} ) is the latent variable matrix (latent features with ( K
\ll D )). - ( W \in \mathbb{R}\^{}\{D \times K\} ) is the matrix of
principal components (projection matrix). - ( \epsilon ) is Gaussian
...
\NormalTok{num\_features }\OperatorTok{=} \DecValTok{5}
\NormalTok{true\_latent\_dim }\OperatorTok{=} \DecValTok{2}

\CommentTok{\# Simulate low{-}dimensional latent variables}
\NormalTok{z }\OperatorTok{=}\NormalTok{ tf.random.normal(shape}\OperatorTok{=}\NormalTok{(num\_samples, true\_latent\_dim))}

\CommentTok{\# Generate a weight matrix for the principal components}
\NormalTok{w }\OperatorTok{=}\NormalTok{ tf.random.normal(shape}\OperatorTok{=}\NormalTok{(num\_features, true\_latent\_dim))}

\CommentTok{\# Generate observed data with noise}
\NormalTok{x }\OperatorTok{=}\NormalTok{ tf.matmul(z, w, transpose\_b}\OperatorTok{=}\VariableTok{True}\NormalTok{) }\OperatorTok{+}\NormalTok{ tf.random.normal(shape}\OperatorTok{=}\NormalTok{(num\_samples, num\_features))}

\CommentTok{\# Define the Bayesian PCA model}
\KeywordTok{def}\NormalTok{ model\_fn():}
\NormalTok{    z }\OperatorTok{=} \ControlFlowTok{yield}\NormalTok{ tfd.Normal(loc}\OperatorTok{=}\FloatTok{0.}\NormalTok{, scale}\OperatorTok{=}\FloatTok{1.}\NormalTok{, sample\_shape}\OperatorTok{=}\NormalTok{(num\_samples, true\_latent\_dim), name}\OperatorTok{=}\StringTok{"z"}\NormalTok{)}
\NormalTok{    w }\OperatorTok{=} \ControlFlowTok{yield}\NormalTok{ tfd.Normal(loc}\OperatorTok{=}\FloatTok{0.}\NormalTok{, scale}\OperatorTok{=}\FloatTok{1.}\NormalTok{, sample\_shape}\OperatorTok{=}\NormalTok{(num\_features, true\_latent\_dim), name}\OperatorTok{=}\StringTok{"w"}\NormalTok{)}
\NormalTok{    x\_obs }\OperatorTok{=} \ControlFlowTok{yield}\NormalTok{ tfd.Normal(loc}\OperatorTok{=}\NormalTok{tf.matmul(z, w, transpose\_b}\OperatorTok{=}\VariableTok{True}\NormalTok{), scale}\OperatorTok{=}\FloatTok{1.}\NormalTok{, name}\OperatorTok{=}\StringTok{"x\_obs"}\NormalTok{)}

\CommentTok{\# Specify the model and inference}
\NormalTok{model }\OperatorTok{=}\NormalTok{ tfd.JointDistributionCoroutineAutoBatched(model\_fn)}
\NormalTok{surrogate\_posterior }\OperatorTok{=}\NormalTok{ tfp.experimental.vi.build\_factored\_surrogate\_posterior(model)}

\CommentTok{\# Fit the model}
\NormalTok{losses }\OperatorTok{=}\NormalTok{ tfp.vi.fit\_surrogate\_posterior(}
\NormalTok{    target\_log\_prob\_fn}\OperatorTok{=}\NormalTok{model.log\_prob,}
\NormalTok{    surrogate\_posterior}\OperatorTok{=}\NormalTok{surrogate\_posterior,}
\NormalTok{    optimizer}\OperatorTok{=}\NormalTok{tf.optimizers.Adam(learning\_rate}\OperatorTok{=}\FloatTok{0.1}\NormalTok{),}
\NormalTok{    num\_steps}\OperatorTok{=}\DecValTok{200}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Bayesian PCA is formulated as a latent variable model, with the
...
Where: - ( X ) is the observed data. - ( Z ) is the latent variable
matrix, which explains the structure of the data in a lower-dimensional
space. - ( W ) is the matrix of principal components (the projection
matrix). - ( \sigma\^{}2 ) is the noise variance, which represents the
variability in the data not explained by the principal components.

\subsection{Priors}\label{priors}

We place Gaussian priors on both the latent variables \emph{Z} and the
principal components \emph{W}:
...
Where \emph{α} is a hyperparameter controlling the variance of the prior
over \emph{W}.

\subsection{Posterior Inference}\label{posterior-inference}

We compute the posterior distribution over the latent variables and the
...
Inference in Bayesian PCA involves approximating this posterior
distribution using techniques like Variational Inference or Markov Chain
Monte Carlo (MCMC).
...
\subsection{\texorpdfstring{\emph{Frequentist
formulation}}{Frequentist formulation}}\label{frequentist-formulation-16}
...
\subsection{\texorpdfstring{\emph{Frequentist
formulation}}{Frequentist formulation}}\label{frequentist-formulation-17}
