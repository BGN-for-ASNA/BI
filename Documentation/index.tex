...
🛈}}, \phantomsection\label{Uncertainty}{{incorporation of prior
knowledge 🛈}} and \phantomsection\label{Uncertainty}{{flexibility for
complex models 🛈}}.
...
e.g., \texttt{m.normal(alpha\ +\ beta\ *\ x,\ s,\ obs=y)}.
...
for (\(\alpha\)), slope (\(\beta\)), and standard deviation
(\(\sigma\)):
...
Notice that for eah parameter declared in the model you will need to
give it a unique name as well as a shale. The shape is the number of
parameters you want to estimate. For example, if you want to estimate a
different \(\beta\) for each predictor, you would need to declare
\(\beta\) with a shape equal to the number of predictors. By default,
the shape is one those technically you don't need to specify it. In this
example we only wanted to highlight this feature.
...
🛈}} to evaluate how well a given set of parameters value fits the data:
...
\item
  ...
  representing our updated beliefs after observing the data.
\end{itemize}

This distribution reflects our updated beliefs about the parameters
after observing the data. It tells us not only the most likely value of
\(\theta\),(e.g., \(\alpha\), \(\beta\), and \(\sigma\) in our case) but
also quantifies the uncertainty in these estimates.
...
\href{}{Bayesian Inference}. In BI, we use MCMC and it can be call as
...
\texttt{bi.diagnostics.XXX} where \texttt{XXX} is the name of the
diagnostic tool.
...
the table below. In BI, wwe can compare models using
\emph{Watanabe-Akaike Information Criterion (WAIC)} with the function
\texttt{m.aic(model1,model2)}.
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, titlerule=0mm, left=2mm, colback=white, breakable, opacityback=0, colframe=quarto-callout-caution-color-frame, arc=.35mm, bottomtitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, toprule=.15mm]
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ dist.normal( }\DecValTok{178}\NormalTok{, }\DecValTok{20}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{,shape}\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
\NormalTok{    b }\OperatorTok{=}\NormalTok{ dist.lognormal(  }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{,shape}\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))   }
\NormalTok{    s }\OperatorTok{=}\NormalTok{ dist.uniform( }\DecValTok{0}\NormalTok{, }\DecValTok{50}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{,shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, titlerule=0mm, left=2mm, colback=white, breakable, opacityback=0, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm]
...
\NormalTok{    sigma }\OperatorTok{=}\NormalTok{ dist.exponential(}\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{, shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
\NormalTok{    bws }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\FloatTok{0.25}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}bws\textquotesingle{}}\NormalTok{, shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
\NormalTok{    bs }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\FloatTok{0.25}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}bs\textquotesingle{}}\NormalTok{, shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
\NormalTok{    bw }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\FloatTok{0.25}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}bw\textquotesingle{}}\NormalTok{, shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
\NormalTok{    a }\OperatorTok{=}\NormalTok{ dist.normal(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.25}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{, shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,))}
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ bi.dist.normal(}\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{4}\NormalTok{,), name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{    s }\OperatorTok{=}\NormalTok{ bi.dist.exponential( }\DecValTok{1}\NormalTok{, shape }\OperatorTok{=}\NormalTok{ (}\DecValTok{1}\NormalTok{,), name }\OperatorTok{=} \StringTok{\textquotesingle{}s\textquotesingle{}}\NormalTok{)    }
...
\NormalTok{model }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(kcal\_per\_g, index\_clade)\{}
  \CommentTok{\# Parameters priors distributions}
\NormalTok{  beta }\OtherTok{=} \FunctionTok{bi.dist.normal}\NormalTok{( }\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{name =} \StringTok{\textquotesingle{}beta\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    m.betabinomial(total\_count }\OperatorTok{=}\NormalTok{ applications, concentration1 }\OperatorTok{=}\NormalTok{ concentration1, concentration0 }\OperatorTok{=}\NormalTok{ concentration0, obs}\OperatorTok{=}\NormalTok{admit)}
...
\NormalTok{m }\OperatorTok{=}\NormalTok{ bi()}
\CommentTok{\# import data {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m.data(}\StringTok{\textquotesingle{}../resources/data/Kline.csv\textquotesingle{}}\NormalTok{, sep}\OperatorTok{=}\StringTok{\textquotesingle{};\textquotesingle{}}\NormalTok{) }
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{3}\NormalTok{, }\FloatTok{0.5}\NormalTok{, shape}\OperatorTok{=}\NormalTok{ (}\DecValTok{2}\NormalTok{,), name}\OperatorTok{=}\StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{)}
\NormalTok{    b }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\FloatTok{0.2}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{2}\NormalTok{,), name}\OperatorTok{=}\StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{1}\NormalTok{,))}
\NormalTok{    b }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{1}\NormalTok{,))}
\NormalTok{    l }\OperatorTok{=}\NormalTok{ jnp.exp(log\_days }\OperatorTok{+}\NormalTok{ a }\OperatorTok{+}\NormalTok{ b }\OperatorTok{*}\NormalTok{ monastery)}
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ dist.normal(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, name }\OperatorTok{=} \StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{, shape}\OperatorTok{=}\NormalTok{ (}\DecValTok{2}\NormalTok{,))}
\NormalTok{    b }\OperatorTok{=}\NormalTok{ bi.dist.halfnormal(}\FloatTok{0.5}\NormalTok{,  name }\OperatorTok{=} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    m.categorical(probs }\OperatorTok{=}\NormalTok{  p, obs}\OperatorTok{=}\NormalTok{career)}
...
\NormalTok{    sigma }\OperatorTok{=}\NormalTok{ dist.exponential( }\DecValTok{1}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{1}\NormalTok{,), name }\OperatorTok{=} \StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{)}
\NormalTok{    a\_bar }\OperatorTok{=}\NormalTok{ dist.normal( }\FloatTok{0.}\NormalTok{, }\FloatTok{1.5}\NormalTok{, shape}\OperatorTok{=}\NormalTok{(}\DecValTok{1}\NormalTok{,), name }\OperatorTok{=} \StringTok{\textquotesingle{}a\_bar\textquotesingle{}}\NormalTok{)}
\NormalTok{    alpha }\OperatorTok{=}\NormalTok{ dist.normal( a\_bar, sigma, shape}\OperatorTok{=}\NormalTok{ tank.shape, name }\OperatorTok{=} \StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{)}
\NormalTok{    p }\OperatorTok{=}\NormalTok{ alpha[tank]}
    \BuiltInTok{print}\NormalTok{(p.shape)}
\NormalTok{    m.binomial(total\_count }\OperatorTok{=}\NormalTok{ density, logits }\OperatorTok{=}\NormalTok{ p, obs}\OperatorTok{=}\NormalTok{surv)}
...
\CommentTok{\# Summary {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{m.summary(}\FloatTok{0.89}\NormalTok{) }\CommentTok{\# Get posterior distributions}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    m.normal(mu, sigma, obs}\OperatorTok{=}\NormalTok{wait)}
...
\NormalTok{    m.oisson(lambda\_, obs}\OperatorTok{=}\NormalTok{total\_tools)}
