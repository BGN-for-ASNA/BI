...
For computational reasons, it is often better to implement a [<span style="color:#0D6EFD">centered version of the varying intercept 🛈</span>]{#RFcentered} that is equivalent to the *Multivariate Normal distribution* approach:
