...
## Note(s)
- By defining this block model within our network model, we are estimating [assortativity 🛈](# "The tendency of nodes to connect with similar nodes") and [disassortativity 🛈](# "The tendency of nodes to connect with dissimilar nodes.") for categorical variables.
