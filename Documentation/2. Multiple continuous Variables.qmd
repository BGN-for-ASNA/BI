...
model <- function(height, weight, age){
  # Parameter prior distributions
  alpha = bee.dist.normal( 0, 0.5, name = 'a')
  beta1 = bee.dist.normal( 0, 0.5, name = 'b1')
  beta2 = bee.dist.normal(  0, 0.5, name = 'b2')   
  sigma = bee.dist.uniform(0, 50, name = 's')
  # Likelihood
  m$normal(alpha + beta1 * weight + beta2 * age, sigma, obs=height)
}
...
- $\beta_k$ are the prior distributions for the _k_ distinct regression coefficients.
