...
$$
logit(𝑝_𝑘)=𝑋_1∗𝑊_{1𝑘}+𝑋_2∗𝑊_{2𝑘}+...+𝑋_𝑛∗𝑊_{𝑛𝑘}+𝑏_k
$$
Where:
...
$logit(𝑝_𝑘)$ is the log-odds of category $k$.
...
- In a multinomial model, you need K − 1 linear models for K types of events. Estimates need to be converted to a [simplex 🛈](8.&#32;Multinomial.md "A simplex is a vector of k−1 probabilities that sum to one."). For this, we can convert regressions outputs using the softmax function (see "nn.softmax" line in code).
