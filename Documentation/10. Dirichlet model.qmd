...
# True parameters
true_alpha = np.array([0.5, -0.5, 0.0]) # Last is reference
true_beta = np.array([1.0, 0.5, 0.0])   # Last is reference
true_kappa = 10.0
...
print(f"True alpha: {true_alpha[:2]}")
print(f"True beta: {true_beta[:2]}")
...
# Run sampler ------------------------------------------------
m.fit(model_dirichlet, progress_bar=False)
