...
The examples below use the NBDA dataset bundled with the **BI** package (adapted from the STbayes package, @STBayes). It contains acquisition events for 50 individuals across 1 trial and their undirected social network.
