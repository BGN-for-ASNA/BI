...
description: "Modeling how information, behaviors, or diseases spread through a network over time."
categories: [Network Analysis, Graph Theory, Social transmission]
...
## Example
Below is an example code snippet demonstrating Bayesian Multiplex network model using the Bayesian Inference (BI) package @nightingale2015quantifying:
