...
data_path = files('BEE.resources.data') / 'Kline2.csv'
m.data(data_path, sep=';') 

data_path2 = files('BEE.resources.data') / 'Kline2.csv'
...
model <- function(Dmat, population, society, total_tools){
  a = bee.dist.exponential(1, name = 'a')
  b = bee.dist.exponential(1, name = 'b')
  g = bee.dist.exponential(1, name = 'g')
  
  # non-centered Gaussian Process prior
  etasq = bee.dist.exponential(2, name = 'etasq')
  rhosq = bee.dist.exponential(0.5, name = 'rhosq')
  z = bee.dist.normal(0,1, name = 'z', shape = c(10))
...
- $(0, ..., 0)$ represents the mean vector of the multivariate normal distribution of the same size as the number of random variables and set to [<span style="color:#0D6EFD">zero 🛈</span>]{#kernelMean0}.
