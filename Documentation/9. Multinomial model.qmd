...
model <- function(income, career){
  ...
  alpha = bee.dist.normal(0, 1, name='alpha', shape = c(2))
  beta = bee.dist.halfnormal(0.5, name='beta')
...
- $p_{ik}$ is the probability of the 𝑖-th observation being in category 𝑘.
