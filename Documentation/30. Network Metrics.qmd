...
description: "An overview of key metrics used to describe and analyze the structure and properties of networks."
categories: [Network Analysis, Graph Theory]
image: "Figures/26.png"
order: 30
reading-time: true
--- 
This overview is from @NM.

## General Principles
Network metrics are mathematical calculations to quantify specific features of a network, including global, nodal, and polyadic measures. Unlike other chapters, here we will present a suite of the most commonly used network metrics and the corresponding BF functions under the class ```m.net.```, implemented with JAX and usable within any BF model. This section is inspired by XXX, and users willing to dig further are invited to read and cite this paper.
