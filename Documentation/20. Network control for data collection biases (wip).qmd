# Modeling Network
Data collection biases are a persistent issue in studies of social networks. Two main types of biases can be considered: [exposure biases 🛈](# "Heterogeneity in observations between individuals leading to over- and under-sampling of some individuals") and [censoring biases 🛈](# "Missing interactions within observation leading to over- and under-estimation of interactions (e.g., Females birds may have cryptic phenotype compare to male birds, leading to higher probability to miss interactions during observations)").
