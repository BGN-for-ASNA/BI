...
Below we demonstrate how to implement a Gaussian Copula in Python, R, and Julia, modeling a bivariate relationship. For Python, we use the BF framework to define custom marginal distributions and perform BayesForge.
...
# -------------------------------------------------------------------
# 2. Built-in Copula (Beta & Poisson) with BF
# -------------------------------------------------------------------
m = bf('cpu')
...
class BetaPoissonMarginal(dist.Distribution):
    ...
    def icdf(self, u):
        ...
        # Coerce back to JAX arrays to integrate into the regular BF/JAX pipeline properly
