...
def model(gid, applications, admit):
    ...
    m.lk.betabinomial(total_count = applications, concentration1 = concentration1, concentration0 = concentration0, obs=admit)
...
model <- function(gid, applications, admit){
  ...
  eta = (1 - pbar) * t
  # Likelihood
  m$lk$betabinomial(total_count=applications, concentration1=gamma, concentration0=eta, obs=admit)
}
