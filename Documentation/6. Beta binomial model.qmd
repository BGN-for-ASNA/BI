# Beta-Binomial model
## General Principles
To model the relationship between a binary outcome variable representing success counts and one or more indepedent variables with [overdispersion 🛈](7.&#32;Poisson&#32;model.qmd "Overdispersion refers to a situation in statistical modeling where the variability of the data exceeds what is expected under the assumed model. In this case, by the binomial distribution."), we can use Beta-Binomial model.
