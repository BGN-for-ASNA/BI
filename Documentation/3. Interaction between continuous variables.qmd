...
data_path = files('BEE.resources.data') / 'tulips.csv'
...
model <- function(blooms, water,shade){
  ...
  alpha = bee.dist.normal( 0.5, 0.25, name = 'a')
  beta1 = bee.dist.normal( 0,  0.25, name = 'b1')
  beta2 = bee.dist.normal(  0,  0.25, name = 'b2')
  beta_interaction_ = bee.dist.normal(  0, 0.25, name = 'bint')
  sigma = bee.dist.normal(0, 50, name = 's')
  # Likelihood
