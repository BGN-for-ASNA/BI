...
$$
𝑌 = \alpha + \beta_1*𝑋_1∗+\beta_2*𝑋_2+\\beta_{interaction}*𝑋_1∗𝑋_2 + 𝜖
$$
...
$$
p(Y∣X_1​ ,X_2​ , \beta_1, \beta_2, \beta_{interaction} ) = \\Normal(\alpha +  \beta_1 * X_1​ + \beta_1 - X_2​​ + \beta_{interaction} * X_1​ ∗X_2​ ,σ² )\\
𝑝(\alpha)=Normal(0,1)\\
𝑝(\beta_1)=Normal(0,1)\\
𝑝(\beta_2)=Normal(0,1)\\
