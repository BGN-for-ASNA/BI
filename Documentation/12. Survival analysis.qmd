...
1.  **Hazard Function**:
    ...
    $$Y_i(t) = \text{Poisson}(\lambda(t) * censoring(t))$$
    ...
    $$\sigma^2_\beta \sim \text{Uniform}(0, 10)$$
    ...
    -   $\beta$: Regression coefficients capturing the effect of $x$ on the hazard are assigned a prior with a $Normal$ distribution.
