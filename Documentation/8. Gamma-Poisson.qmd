...
from BEE import bee
# Setup device ------------------------------------------------
m = bee(platform='cpu') # Import

# Import Data & Data Manipulation ------------------------------------------------
# Import
from importlib.resources import files
data_path = files('BEE.resources.data') / 'Sim dat Gamma poisson.csv'
...
model <- function(log_days, monastery, y){
  ...
  alpha = bee.dist.normal(0, 1, name='alpha', shape=c(1))
  beta = bee.dist.normal(0, 1, name='beta', shape=c(1))
