...
\title{The Bayesian Inference library for Python and R}
...
varying_intercept, varying_slope = m.effects.varying_intercept_slope(
  N_group = 20,
  group = jnp.arrange(20), # dummy group
  global_intercept= a,
  global_slope= b,
  group_name = 'cafe',
  sample=True
...
\begin{figure}[p]
    ...
    \begin{subfigure}{\linewidth}
        \caption{}
        \centering
        \includegraphics[width=0.49\linewidth]{Benchmark_plot.png}
        \label{fig:benchmark}
    \end{subfigure}
    ...
    \begin{subfigure}{0.49\linewidth}
        \caption{}
        \centering
        \includegraphics[width=\linewidth]{Posteriors_plot.png}
        \label{fig:posterior}
    \end{subfigure}
